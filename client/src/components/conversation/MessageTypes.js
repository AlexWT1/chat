      ...
      <Box
        ...
        <Stack spacing={2}>
          <Stack
            ...
            <Image size={48} />
            <Typography variant="caption">Abstartct.png</Typography>
            <IconButton>
              <DownloadSimple />
            </IconButton>
          </Stack>
      ...
      <Box
        ...
        <Stack spacing={2}>
          <Stack
            ...
            />
            <Stack spacing={2}>
              <Typography variant="subtitle2"> Creating Cha App</Typography>
              <Typography
                variant="subtitle2"
...
export { TimeLine, TextMessage, MediaMessage, ReplayMessage, LinkMessage, DocumentMessage };
